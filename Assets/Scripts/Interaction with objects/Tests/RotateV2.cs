...
public class RotateV2 : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        initialRotation2 = target2.rotation.eulerAngles;
    ...
    private void Update()
    {
        ...
        xoffatehr = target2.rotation.eulerAngles;
        //Vector3 xoftarget3 = target3.transform.rotation.eulerAngles;
        Debug.Log($"local Rotation x axis  of target2 is {xoffatehr}");
        ...
        //3rd try no idea of how this works
        //var rotation = Quaternion.LookRotation(target2.position);
        //target.rotation = Quaternion.Slerp(target.rotation, rotation, Time.deltaTime *50);
